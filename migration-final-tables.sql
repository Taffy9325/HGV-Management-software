-- Final migration to add remaining tables for role-based user management
...
-- Step 2: Add driver_hours table for tracking driver hours
...
-- Step 3: Add driver_documents table for documents sent to drivers
...
-- Step 4: Add accident_reports table for accident reporting
...
BEGIN
    ...
    RAISE NOTICE 'Added tables: driver_hours, driver_documents, accident_reports';
    RAISE NOTICE 'Role-based user management system is now ready!';
END $$;
