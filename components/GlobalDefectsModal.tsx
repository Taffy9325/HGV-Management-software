...
interface GlobalDefectsModalProps {
  isOpen: boolean
  onClose: () => void
  onDefectCompleted: () => void
}

export default function GlobalDefectsModal({
  isOpen,
  onClose,
  onDefectCompleted
}: GlobalDefectsModalProps) {
  ...
  const fetchDefects = async () => {
    try {
      ...
      if (filterSeverity !== 'all') {
        query = query.eq('severity_level', filterSeverity)
      }
  ...
  }, [filterStatus, filterSeverity, isOpen])
  ...
  const completeDefect = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fetchDefects()
      onDefectCompleted() // Notify parent to refresh count
    } catch (err: any) {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Manage defects across all vehicles
              </p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          ...
          {showCompletionForm && selectedDefect && (
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Vehicle: {selectedDefect.vehicles?.registration} - {selectedDefect.vehicles?.make} {selectedDefect.vehicles?.model} ({selectedDefect.vehicles?.year})
              </p>
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400 mt-1">All defects have been resolved</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 mt-2 text-xs text-gray-500">
                        <span>Vehicle: {defect.vehicles?.registration}</span>
